...
def input_params():
    ...
    return source_directory, destination_directory, stimuli_path  # do NOT change
    ...
    for root, _, files in os.walk(source_directory):
        for file in files:
            if file.lower().endswith('.wav'):
                ...
                # remove if you wish to process all the files
                if count == 500:
                    break
...
def main():
    source_directory, destination_directory, stimuli_path = input_params()
