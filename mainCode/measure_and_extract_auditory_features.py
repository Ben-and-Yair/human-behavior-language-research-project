...
"""Accumulation of code from different sources that receive a source directory filled with audio files and
computes a large plethora of auditory features using parselmouth (which uses PRAAT) such as intensity, pitch,
...
def input_params():
    ...
    return source_directory # do NOT change
